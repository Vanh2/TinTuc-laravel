    ...
    <div class="container-fluid pt-5 mb-3">
        <div class="container">
            ...
            <div class="owl-carousel news-carousel carousel-item-4 position-relative">
                <?php
                $trending = DB::table("news")->where("category_id", "6")->get();
                ?>
                @foreach($trending as $rows)
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    <?php
                    $tag = DB::table("categories")->where("id", "6")->get()
                    ?>
                    @foreach($tag as $rowsSub)
                    ...
                    <div class="overlay">
                        ...
                        <a title="{{ $rows->name }}" class="h6 m-0 text-white text-uppercase font-weight-semi-bold"
                            style="text-overflow:ellipsis;width:200px;resize:horizontal;overflow:hidden;white-space:nowrap"
                            href="">{{ $rows->name }}</a>
                    </div>
                    @endforeach
                </div>
